...
$ git clone https://github.com/luisoliveira1003/worldtrip-ignite-react.git
```

```
# Acesse a pasta da aplicação
$ cd worldtrip-ignite-react
...
# se encontra na pasta worldtrip-ignite-react
-->
...
[WorldTrip](https://worldtrip-ignite-react.vercel.app/)

&nbsp;

## 📝 Licença

Este projeto está licenciado sob a Licença MIT. Veja o arquivo de [LICENÇA](https://github.com/luisoliveira1003/worldtrip-ignite-react/blob/main/LICENSE) para detalhes.
